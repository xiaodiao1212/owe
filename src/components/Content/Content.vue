  ...
  private carousel = [
    [
      ...
      },
      {
        ...
        order: '05熊二抓娃娃',
        url: require('assets/cover/05.png'),
      },
      {
        title: 'YS',
      ...
      },
      {
        ...
        order: '07错题plus',
        url: require('assets/cover/07.png'),
      },
      {
        title: '优形',
    ...
    [
      {
        ...
        order: '09Musiers',
        url: require('assets/cover/09.png'),
      },
      {
        title: '6Road',
      ...
      },
      {
        ...
        order: '11美瑞健康',
        url: require('assets/cover/11.png'),
      },
      {
        title: '悬赏猫',
        describe: '悬赏猫_APP视觉设计，一款专注手机赚钱的APP',
        order: '12悬赏猫',
        url: require('assets/cover/12.png'),
      },
      {
        title: 'keepwell',
